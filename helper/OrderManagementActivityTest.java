...
public class OrdermanagementActivityTest {
    ...
    private ActivityScenario<OrdermanagementActivity> activityScenario;

    @Before
    public void setUp() {
        activityScenario = ActivityScenario.launch(OrdermanagementActivity.class);
    }

    @Test
    public void testOrdermanagementActivityNotNull() {
    ...
    @Test
    public void testOrdermanagementActivityWindowFeature() {
        activityScenario.onActivity(activity -> {
    ...
    @Test
    public void testOrdermanagementActivityStatusBarColor() {
        activityScenario.onActivity(activity -> {
            Window window = activity.getWindow();
            assertNotNull(window);
